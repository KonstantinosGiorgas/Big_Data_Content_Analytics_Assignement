...
## Trained model
You can find the model already trained in the flask_app directory ofths repository saved as a `.h5` file and load it using the `load_model('image_class_model.h5')` command.
