...
4. Start Flask and make the webservise visible andavailabel to all computers in the network using the follwing command: `flask run --host=0.0.0.0` or `flask run` to make the service available only through your local machine./n
